...
function openMenuPop(card) {
    ...
    var cal = card.getAttribute('data-berat');
    ...
    document.getElementById('mpMeta').innerHTML =
        '<div class="mpm"><div class="mpmv">' + cal + ' gram</div><div class="mpml">berat</div></div>' +
        '<div class="mpm"><div class="mpmv">' + time + ' hst</div><div class="mpml">Usia Panen</div></div>' +
    ...
    document.getElementById('mpAddCart').innerHTML = '<i class="fas fa-seedling"></i> BUKTIKAN';
